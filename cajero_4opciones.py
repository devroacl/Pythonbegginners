...
while flag:
    ...
    if opcion == "1":
        ...
        newMonto=0
        while newMonto <= 0: #ciclo de validación
            try:
                newMonto = int(input('Ingrese monto a depositar: $'))
                if newMonto <= 0:
                    print('Debe depositar un valor MAYOR a CERO')
            except:
                print('Solo se admiten números!!!')
        #acá estoy segura de tener un newMonto correco
        saldo += newMonto
